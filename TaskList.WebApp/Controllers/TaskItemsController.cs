...
namespace TaskList.WebApp.Controllers
{
    public class TaskItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TaskTitle,TaskDetails")] TaskItem taskItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,TaskTitle,TaskDetails")] TaskItem taskItem)
        {
            if (id != taskItem.Id)
            {
                return NotFound();
